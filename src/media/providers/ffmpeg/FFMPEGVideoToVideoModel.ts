/**
 * FFMPEGVideoToVideoModel - Pure Video Transformation Implementation
 * 
 ...
 * 
 * COPIED FROM: FFMPEGVideoFilterModel - maintaining exact same functionality
 */
...
export class FFMPEGVideoToVideoModel extends VideoToVideoModel {
  constructor(
